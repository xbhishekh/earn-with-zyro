  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <div className="fixed bottom-0 left-0 right-0 lg:left-72 bg-card/95 backdrop-blur-sm border-t border-border px-6 py-5 z-40">
          <div className="flex items-center justify-between max-w-2xl mx-auto">
            ...
            <Button 
              ...
              size="lg"
              className="h-14 px-12 rounded-xl font-bold text-lg bg-primary hover:bg-primary/90 shadow-lg"
            >
              Submit
            </Button>
          </div>
