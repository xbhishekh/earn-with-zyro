...
const TEAM_CLIPORAX_USER_ID = "00000000-0000-0000-0000-000000000001";
...
const Messages = () => {
  ...
  const fetchConversations = useCallback(async () => {
    ...
    try {
      ...
      if (!profileMap.has(TEAM_CLIPORAX_USER_ID) && otherUserIds.includes(TEAM_CLIPORAX_USER_ID)) {
        profileMap.set(TEAM_CLIPORAX_USER_ID, {
          user_id: TEAM_CLIPORAX_USER_ID,
          username: "cliporax_team",
          display_name: "Team CliporaX",
  ...
  const isTeamCliporaX = selectedConversation?.other_user?.user_id === TEAM_CLIPORAX_USER_ID;
          ...
          {loading ? (
            ...
            <div>
              {allConversations.map((convo) => {
                const isTeamCliporaX = convo.other_user.user_id === TEAM_CLIPORAX_USER_ID;
                    ...
                    >
                      <Avatar className="w-12 h-12 shrink-0">
                        ...
                        <AvatarFallback className={cn(
                          ...
                          isTeamCliporaX ? "bg-primary" : "bg-gradient-to-br from-gray-400 to-gray-600"
                        )}>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-0.5">
                          <div className="flex items-center gap-1 min-w-0">
                            ...
                            {(isTeamCliporaX || convo.other_user.is_verified) && (
                    ...
                    {groupedMessages.map((group) => (
                      <div key={group.date}>
                        ...
                        {group.messages.map((message, index) => {
                          ...
                          const isSysMsg = message.user_id === TEAM_CLIPORAX_USER_ID;
              ...
              <div className="px-4 py-3 border-t border-border bg-background">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-foreground text-sm">This is the official CliporaX notification channel</p>
                    <p className="text-xs text-muted-foreground">CliporaX will always use verified accounts to communicate with you</p>
                  </div>
                </div>
              </div>
            ) : (
