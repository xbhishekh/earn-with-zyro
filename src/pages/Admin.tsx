      ...
      >
        ...
        <div className="p-4 border-b border-border">
          <Link to="/" className="flex items-center gap-3">
            <img loading="lazy" decoding="async" src={logo} alt="CliporaX" className="w-10 h-10 rounded-xl flex-shrink-0 object-cover" />
            {sidebarOpen && (
              <div>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 glass-card border-b border-border">
        <div className="flex items-center justify-between px-4 h-14">
          <Link to="/" className="flex items-center gap-2">
            <img loading="lazy" decoding="async" src={logo} alt="CliporaX" className="w-8 h-8 rounded-lg object-cover" />
