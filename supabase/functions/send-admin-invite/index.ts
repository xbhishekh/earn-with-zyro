...
<head>
  ...
  <title>Admin Invitation - CliporaX</title>
</head>
<body style="margin: 0; padding: 0; background-color: #0a0a0a; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
  <table role="presentation" style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            <td align="center" style="padding-bottom: 32px;">
              <div style="display: inline-flex; align-items: center; gap: 12px;">
                ...
                <span style="font-size: 28px; font-weight: 700; background: linear-gradient(135deg, #ff6b35, #f7c59f); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">CliporaX</span>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="background: linear-gradient(145deg, #1a1a1a, #0d0d0d); border-radius: 16px; padding: 40px 32px; border: 1px solid #2a2a2a;">
              ...
              <p style="margin: 0 0 32px 0; font-size: 15px; color: #888888; text-align: center; line-height: 1.6;">
                You've been invited to join CliporaX as a <strong style="color: #ff6b35;">${roleLabel}</strong>
              </p>
              ...
              <div style="background: rgba(255, 107, 53, 0.1); border-radius: 12px; padding: 20px; margin-bottom: 24px;">
                ...
                <ol style="margin: 0; padding-left: 20px; font-size: 14px; color: #aaaaaa; line-height: 1.8;">
                  <li>Go to CliporaX and click "Sign Up"</li>
    ...
    const { data: emailData, error: emailError } = await resend.emails.send({
      ...
      to: [email],
      subject: `🎉 You're Invited to Join CliporaX as ${roleLabel}`,
      html: html,
    });
